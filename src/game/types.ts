...
/** 单位类型 */
export type UnitType = 'tank' | 'ifv' | 'artillery' | 'scout' | 'infantry' | 'sam' | 'engineer' | 'supply' | 'helicopter' | 'mlrs' | 'atgm' | 'uav' | 'command' | 'ew';
...
/** 预设地图类型 */
export type MapType = 'random' | 'mountain-pass' | 'river-valley' | 'urban-warfare' | 'desert-storm' | 'procedural';
